...
let wordpress = document.getElementById("python");
crearBarra(wordpress);
let photoshop = document.getElementById("redes");
...
function efectoHabilidades(){
    ...
    if(distancia_skills>=300 && entro==false){
        ...
        const intervalWordpress = setInterval(function(){
            pintarBarra(python, 13, 2, intervalWordpress);
        },100);
        const intervalPhotoshop = setInterval(function(){
            pintarBarra(redes, 15, 3, intervalPhotoshop);
        },100);
    }
}
